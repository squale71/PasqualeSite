...
(function() {
  ...
  PasqualeSite.ViewModels.PostsViewModel = (function() {
    function PostsViewModel() {
      ...
      this.RSSFeeds = ko.observableArray([]).withMergeConstructor(PasqualeSite.ViewModels.RSSViewModel, true);
      ...
      this.RSSGridOptions = {
        ...
        enablePaging: true,
        multiSelect: false,
        selectedItems: this.SelectedRSS,
        afterSelectionChange: (function(_this) {
          return function() {
            $('#rssGrid').hide();
            return $('#editRSS').show();
      ...
      this.BackToRSSGrid = (function(_this) {
        return function() {
          $('#editRSS').hide();
          return $('#rssGrid').show();
        };
      ...
      this.AddRSS = (function(_this) {
        return function() {
          if (_this.NewRSSFeed() && _this.NewRSSFeed().trim() !== "") {
            return $.ajax({
              url: approot + "Admin/AddFeed",
              data: {
                name: _this.NewRSS(),
                url: _this.NewRSSFeed()
              },
              type: "POST",
              success: function(data) {
                var json, theFeed;
                ...
                _this.RSSFeeds.push(theFeed);
                return PasqualeSite.notify("Success Adding New RSS Feed", "success");
              },
              error: function(err) {
                return PasqualeSite.notify("There was a problem saving the feed", "error");
              }
            });
          } else {
            return PasqualeSite.notify("You need to fill in a value in order to add a feed.", "info");
          }
        };
      })(this);
    }
  ...
  PasqualeSite.ViewModels.RSSViewModel = (function() {
    function RSSViewModel() {
      this.Id = ko.observable();
      this.Name = ko.observable();
      this.FeedUrl = ko.observable();
      this.SaveRSS = (function(_this) {
        return function() {
          var newRSS;
          newRSS = {
            Id: _this.Id(),
            Name: _this.Name(),
            FeedUrl: _this.FeedUrl()
          };
          return $.ajax({
            ...
            success: function(data) {
              ...
              return PasqualeSite.notify("Success Updating RSS Feed", "success");
            },
            error: function(err) {
              return PasqualeSite.notify("There was a problem saving the feed", "error");
            }
      ...
      this.DeleteRSS = (function(_this) {
        return function() {
          return $.ajax({
            ...
            type: "POST",
            success: function(data) {
              model.Model.RSSFeeds.remove(_this);
              model.Model.BackToRSSGrid();
              return PasqualeSite.notify("Success Deleting RSS Feed", "success");
            },
            error: function(err) {
              return PasqualeSite.notify("There was a problem deleting the feed", "error");
            }
          });
        };
      })(this);
