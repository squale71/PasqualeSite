...
(function (ko, mapping, exports) {
    ...
    var knockoutElementMapping = function (knockoutElement, dataElement) {
        if (typeof (knockoutElement.mergeConstructor) == "undefined") {
            if (!ko.isComputed(knockoutElement)) {
                ...
                else { knockoutElement(dataElement); }
            }
        }
        else {
            ...
            if (dataElement) {
                dataElement.forEach(function (element) {
                    var arrayElement;
                    if (knockoutElement.arg)
                        arrayElement = new knockoutElement.mergeConstructor(knockoutElement.arg);
                    else
                        arrayElement = new knockoutElement.mergeConstructor();
    ...
    ko.observableArray.fn.withMergeConstructor = function (mergeConstructor, replaceOnMerge, arg) {
